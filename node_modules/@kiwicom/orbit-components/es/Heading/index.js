...
export const getHeadingToken = name => ({
  theme,
  type
}) => {
  const tokens = {
    [TOKENS.weightHeading]: {
      ...
      [TYPE_OPTIONS.DISPLAYSUBTITLE]: theme.orbit.fontWeightNormal,
      // TODO: create token fontWeightHeadingSubDisplay
    ...
    [TOKENS.sizeHeading]: {
      ...
      [TYPE_OPTIONS.DISPLAYSUBTITLE]: theme.orbit.fontSizeHeadingTitle2,
      // TODO: create token fontSizeHeadingSubDisplay
...
export const StyledHeading = styled(({
...
})(["font-family:", ";font-size:", ";font-weight:", ";color:", ";line-height:", ";text-transform:", ";margin:0;margin-bottom:", ";"], ({
  theme
}) => theme.orbit.fontFamily, getHeadingToken(TOKENS.sizeHeading), getHeadingToken(TOKENS.weightHeading), ({
  theme,
  inverted
  ...
  type
}) => type === TYPE_OPTIONS.TITLE5 && "uppercase", getSpacingToken);
