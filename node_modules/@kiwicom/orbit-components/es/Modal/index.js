...
})(["box-sizing:border-box;min-height:100%;display:flex;align-items:flex-start;margin:0 auto;position:fixed;width:100%;border-top-left-radius:9px;border-top-right-radius:9px;transition:", ";top:", ";", ";", ";"], transition(["top"], "normal", "ease-in-out"), ({
  loaded
}) => loaded ? "32px" : "100%", onlyIE(css(["height:1px;"])), media.largeMobile(css(["position:relative;top:0;max-width:", ";align-items:center;"], getSizeToken)));
...
const CloseContainer = styled.div.withConfig({
  ...
  theme,
  scrolled
}) => scrolled && theme.orbit.paletteWhite, transition(["box-shadow", "background-color"], "fast", "ease-in-out"), media.largeMobile(css(["top:", ";right:", ";"], ({
  scrolled,
  fixedClose
...
const ModalWrapperContent = styled.div.withConfig({
...
})(["position:absolute;box-sizing:border-box;border-top-left-radius:9px;border-top-right-radius:9px;background-color:", ";font-family:", ";width:100%;max-height:calc( 100% - ", " - ", " );bottom:", ";box-shadow:", ";overflow-y:auto;overflow-x:hidden;", ";", "{top:", ";opacity:", ";visibility:", ";transition:", ";}", "};", "{margin-bottom:", ";}", ";", ";", ";"], ({
  theme
  ...
  fixedFooter,
  theme
}) => fixedFooter && css(["", "{padding:", ";box-shadow:", ";position:fixed;transition:", ";}", ":last-of-type{padding-bottom:", ";margin-bottom:0;}"], StyledModalFooter, theme.orbit.spaceMedium, ({
  fullyScrolled
  ...
  hasModalSection,
  theme
}) => !hasModalSection && theme.orbit.spaceXLarge, media.largeMobile(css(["position:relative;bottom:auto;border-radius:9px;padding-bottom:0;height:auto;overflow:visible;max-height:100%;", ":last-of-type{padding-bottom:", ";margin-bottom:", ";&::after{content:none;}}", "{margin-bottom:", ";}", "{padding:", ";max-width:", ";position:", ";box-shadow:", ";}", "{top:", ";width:", ";}"], StyledModalSection, ({
  theme
