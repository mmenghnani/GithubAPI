...
})(["display:flex;flex-direction:row;align-items:center;justify-content:center;margin:", ";color:", ";transition:background ", " ease-in-out,box-shadow ", " ease-in-out;> *{width:", ";height:", ";}"], iconSpacing(), ({
  bordered
...
export const StyledButton = styled((_ref) => {
  let {
    ...
    spaceAfter
      ...
      props = _objectWithoutProperties(_ref, ["theme", "component", "circled", "external", "type", "icon", "iconLeft", "iconRight", "sizeIcon", "width", "bordered", "loading", "onlyIcon", "block", "style", "dataTest", "submit", "buttonRef", "ariaControls", "ariaExpanded", "spaceAfter"]);
  ...
  disabled,
  theme
}) => !disabled && css(["box-shadow:0 0 1px 1px ", ",0 0 1px 3px rgba(1,118,210,0.6);&:active{box-shadow:none;}"], theme.orbit.colorTextButtonWhiteBordered), StyledSpinner, getSizeToken(TOKENS.loadingWidth), getSizeToken(TOKENS.loadingHeight));
