...
})(["position:relative;height:13px;width:", ";background-color:", ";border-radius:", ";overflow:hidden;"], function (_ref) {
...
})(["position:absolute;display:block;height:100%;width:100%;top:0;right:0;bottom:0;left:0;box-shadow:inset 0 0 0 1px ", ";border-radius:", ";"], function (_ref4) {
...
function getCountryProps(code, name) {
  ...
  if (!countryCodeExists && process.env.NODE_ENV !== "production" && code) {
    console.warn("Country code not supported: ".concat(code));
  }
...
var CountryFlag = function CountryFlag(props) {
  ...
  return React.createElement(StyledCountryFlag, null, React.createElement(StyledImage, {
    key: code,
    src: "".concat(_consts.baseURL, "/flags/24x0/flag-").concat(code.toLowerCase(), ".jpg"),
    srcSet: "".concat(_consts.baseURL, "/flags/48x0/flag-").concat(code.toLowerCase(), ".jpg 2x"),
    alt: name,
    title: name,
    "data-test": dataTest
