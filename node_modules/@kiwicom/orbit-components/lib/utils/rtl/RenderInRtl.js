...
function (_React$PureComponent) {
  ...
  function RenderInRtl() {
    ...
    _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(RenderInRtl)).call.apply(_getPrototypeOf2, [this].concat(args)));
